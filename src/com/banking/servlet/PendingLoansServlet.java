...
/**
 * Servlet that provides pending loan requests for the admin panel
 */
@WebServlet("/api/pending-loans")
public class PendingLoansServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Get loans data as JSON
        String loansJson = DatabaseUtil.getPendingLoansAsJson();
