...
/**
 * Servlet that provides a list of inactive users for admin approval
 */
@WebServlet("/api/inactive-users")
public class InactiveUsersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Get inactive users as JSON
        String usersJson = DatabaseUtil.getInactiveUsersAsJson();
